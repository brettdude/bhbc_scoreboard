...
//          0.9 - May 2020   - Updated for Bulkham Hills Baseball Club
//
// Acknowledgement:
...
// Command overview
// 4,ScoreHome,Innings,ScoreVisitor,Balls,Strikes,Outs# //display a score on the board
// 5# //test mode

// Wiring layout
// shifter set 1, pins 22 (SRCK), 26 (SERIN),30 (RCK) --> Home score, Inning, Visitors score, 5 characters (e.g. 02305)
...
// set up the headings 
char ScoreHomeHeading[] = "Home Score:";
char InningsHeading[] = "Inning:";
char ScoreVisitorHeading[] = "Visitor Score:";
char BallsHeading[] = "Balls:";
char StrikesHeading[] = "Strikes:";
char OutsHeading[] = "Outs:";
char ScoresTotal[] = "Home Score, Inning and Visitor Score:";
char BallsStrikesandOuts[] = "Balls, Strikes and Outs:";
...
Shifter shifterSet1(5, 22, 26, 30);  //Home Score, Inning, Visitor Score + Balls, Strikes and Outs controlled by pins 22,26 and 30
Shifter shifterSet2(3, 34, 38, 42);  //Balls, Strikes and Outs controlled by pins 34,38 and 42
...
void update_scoreboard()
{
  while ( cmdMessenger.available() )
  {
    ...
    cmdMessenger.copyString(buf, 3);
    strcpy(Balls,buf);
    cmdMessenger.sendCmd(kACK, BallsHeading);
    cmdMessenger.sendCmd(kACK, Balls);
...
void test_mode()
{
    ...
    shifterSet1.display("12112");
    shifterSet2.display("322");
}
